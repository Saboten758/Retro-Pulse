  ...
  return (
    ...
    <RNCamera 
      ...
      <ImageBackground source={require('./assets/cam_overlay.jpg')}  style={{borderColor:'#15151e',flex:1/7,borderTopWidth:10,position:'relative',alignItems:'center'}} blurRadius={1}>
        ...
        <TouchableOpacity  onPress={this.takePicture} style={{alignSelf:'center'}}><Icon name="camera" size={40}/></TouchableOpacity>
        <TouchableOpacity  onPress={this.changeCameraType} style={{alignSelf:'center',marginLeft:20}}><Icon name="refresh" size={40} /></TouchableOpacity>
        </View>
